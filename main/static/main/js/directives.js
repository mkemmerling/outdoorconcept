        ...
        return {
            ...
            link: function (scope, element) {
                ...
                handle.on('mousedown', function (event) {
                    var left_margin = parseInt(element.css('margin-left'), 10),
                        top_margin = parseInt(element.css('margin-top'), 10);

                    // Prevent default dragging of selected content
                    event.preventDefault();

                    startX = element.offset().left - left_margin - event.pageX;
                    startY = element.offset().top - top_margin - event.pageY;
