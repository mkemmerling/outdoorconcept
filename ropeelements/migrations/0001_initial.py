        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('variable', models.CharField(
                    max_length=50, verbose_name='Variable')),
                ('text', models.CharField(
                    max_length=1000, verbose_name='Text')),
                ('text_en', models.CharField(
                    max_length=1000, verbose_name='Text', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(
                    unique=True, max_length=255, verbose_name='Title')),
                ...
                ('description_de', models.TextField(
                    blank=True, max_length=2000, verbose_name='Description',
                    null=True)),
                ('image', ropeelements.models.ImageField(
                    width_field='image_width', blank=True, upload_to='',
                    verbose_name='Image')),
                ('image_width', models.SmallIntegerField(null=True)),
                ('thumbnail', ropeelements.models.ImageField(
                    blank=True, upload_to='thumbnails',
                    verbose_name='Thumbnail')),
                ('direction', models.CharField(
                    blank=True, max_length=100, verbose_name='Direction',
                    choices=[
                        ('owdd', 'one way downhill'),
                        ('owsd', 'one way vertically down'),
                        ('twud', 'vertically two way'),
                        ('twudd', 'two way up or down'),
                        ('twhd', 'two way horizontally or little acclivity'),
                        ('twh', 'two way horizontally'),
                        ('owh', 'one way horizontally')])),
                ('difficulty_from', models.SmallIntegerField(
                    blank=True, null=True, verbose_name='Difficulty',
                ...
                ('child_friendly', models.BooleanField(
                    default=False, verbose_name='best for kids')),
                ('accessible', models.BooleanField(
                    default=False, verbose_name='best for handicapped')),
                ('canope', models.BooleanField(
                    default=False, verbose_name='Canope walk')),
                ('ssb', models.CharField(
                    default='yes', max_length=50, verbose_name='SSB',
                    choices=[('no', 'no'),
                             ('yes', 'yes'),
                             ('powerfan', 'with POWERFAN')])),
            ],
            options={
